...
function trp_mtapi_add_settings($mt_settings)
{
    ...
    if ($status === false): ?>
        ...
        <div class="trp-get-free-license__container" <?php if ($translatepress_version_name !== 'TranslatePress')
            echo 'style="background: #F6F7F7"'; ?>>
            <div class="trp-engine trp-automatic-translation-engine__container" id="mtapi">
                ...
                <div class="trp-automatic-translation-license-notice__wrapper">
                    <svg class="trp-no-license-automatic-translation__icon" width="20" height="20" viewBox="0 0 20 20"
                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M18 10C18 5.58 14.42 2 10 2C5.58 2 2 5.58 2 10C2 14.42 5.58 18 10 18C14.42 18 18 14.42 18 10ZM12 10L15 13L13 15L10 12L7 15L5 13L8 10L5 7L7 5L10 8L13 5L15 7L12 10Z"
                            fill="#9CA1A8" />
                    </svg>
                ...
                <div class="trp-automatic-translation-get-license-buttons">
                    <?php if ($translatepress_version_name == 'TranslatePress'):  /* [utm42] */ ?>
                        <a href="<?php echo esc_url('https://translatepress.com/ai-free/?utm_source=tp-automatic-translation&utm_medium=client-site&utm_campaign=tp-ai-free') ?>"
                            class="trp-get-free-license-link trp-get-free-license-button button-primary" target="_blank"
                            id="trp-enter-license-button">
                            <?php esc_html_e('Create your Free Account', 'translatepress-multilingual'); ?>
                        </a>

                        <span
                            class="trp-secondary-text trp-text-auto"><?php esc_html_e(' or ', 'translatepress-multilingual'); ?></span>
                    <?php endif; ?>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=trp_license_key')) ?>"
                        class="trp-enter-license-link trp-get-free-license-button trp-button-secondary"
                        id="trp-enter-license-button">
                        <?php esc_html_e('Enter your license key', 'translatepress-multilingual'); ?>
                    </a>
                    <?php if ($translatepress_version_name != 'TranslatePress'):   /* [utm43] */ ?>
                        <span
                            class="trp-secondary-text trp-text-auto"><?php printf(esc_html__(' Or %1$spurchase one here%2$s', 'translatepress-multilingual'), '<a href="https://translatepress.com/pricing/?utm_source=tp-automatic-translation&utm_medium=client-site&utm_campaign=activate-license" target="_blank">', '</a>'); ?></span>
                    <?php endif; ?>
            ...
            <?php if ($translatepress_version_name == 'TranslatePress'): ?>
                <div class="trp-automatic-translation-engine__upsale" id="tpai-upsale">
                    ...
                    <span class="trp-secondary-text trp-check-text">
                        <img src="<?php echo esc_url(TRP_PLUGIN_URL . 'assets/images/'); ?>green-circle-check.png" width="20px"
                            height="20px" />
                    ...
                    <div class="trp-upsale-fill" id="<?php echo esc_html($translatepress_version_name) ?>"
                        style="display: none;">
                        <span class="trp-primary-text trp-upsale-text-red">
                            ...
                            <a href="https://translatepress.com/pricing/?utm_source=wpbackend&utm_medium=clientsite&utm_content=tpsettingsAT&utm_campaign=tpaifree"
                                id="trp-upgrade-link" target="_blank">
                                <span class="trp-upsale-text-link">
                                    ...
                                    <svg width="12" height="12" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17 7.3252L7 17.3252M17 7.3252H8M17 7.3252V16.3252" stroke="#354052"
    ...
    if ($status === 'valid'):
        ...
        <div class="trp-engine trp-automatic-translation-engine__container" id="mtapi">
            ...
            <div class="trp-automatic-translation-license-notice__wrapper">
                ...
                printf(
                    wp_kses(__('You have a valid %s <strong>license</strong>.', 'translatepress-multilingual'), array('strong' => array())),
        ...
        <div class="trp-upsale-fill trp-upsale-fill-active-license" id="<?php echo esc_html($translatepress_version_name) ?>"
            style=" display: none ">
            <span class="trp-primary-text trp-upsale-text-red">
                <?php esc_html_e("Get more AI Words and unlock all AI features with TranslatePress Pro.", "translatepress-multilingual"); /* [utm45] */ ?>
                <a href="https://translatepress.com/pricing/?utm_source=tp-automatic-translation&utm_medium=client-site&utm_campaign=tp-ai"
                    id="trp-upgrade-link" target="_blank">
                    <span class="trp-upsale-text-link">
                        <span><?php esc_html_e("Upgrade now", "translatepress-multilingual"); ?></span>
                        <svg width="20" height="20" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M17 7.3252L7 17.3252M17 7.3252H8M17 7.3252V16.3252" stroke="#354052" stroke-width="2"
        ...
        if (isset($_POST['action']) && $_POST['action'] === 'trp_ai_recheck_quota') {
            ...
            if ($nonce_okay) {
                ...
                if ($status === 'valid') {
                    ...
                    if (
                        is_array($response) && !is_wp_error($response) && isset($response['response']) &&
